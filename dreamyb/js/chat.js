const chatInit = () => {
  ...
  let yangbanProfileImage = 'https://i.ibb.co/XZ1NDq3/jinju-dream1.png'
...
<div class="container_yangban_chat_right">
  ...
  const chatInputBtnFunction = async () => {
    ...
    <div class="container_yangban_chat_right">
      ...
      운영되고 있어요. 더욱 좋은 행운을 담아드리기 위해 자그마한 복채와 함께 응원해주시면 진심으로 감사드립니다! 

      <a
        style="text-decoration: none; color: black; width: 100%;"
        href="https://qr.kakaopay.com/Ej9MgSCp05dc04859"
        target='_blank'
        onclick="gtag('event', '${yangbanProfileName}-복채')"
      >
        <button
          style="
