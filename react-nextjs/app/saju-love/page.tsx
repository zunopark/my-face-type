...
export default function SajuLovePage() {
  ...
  // UI 상태
  const [currentImage, setCurrentImage] = useState("/saju-love/img/1.png");
  ...
  const handleStart = () => {
    ...
    setCurrentImage("/saju-love/img/2.png");
  ...
  const handlePrevDialogue = () => {
    if (isAdditionalDialogue) {
      ...
      if (currentDialogue > 0) {
        ...
        setShowDialogue(false);
        setShowLanding(true);
        setCurrentImage("/saju-love/img/1.png");
        setCurrentDialogue(0);
      }
    }
  };
  ...
  const handleInputNext = () => {
    ...
    setCurrentDialogue(0);
    setCurrentImage("/saju-love/img/3.png");
    setShowDialogue(true);
          ...
          <div className="dialogue_wrap active">
            ...
            {showButtons && (
              <div className="dialogue_buttons visible">
                <button className="dialogue_prev_btn" onClick={handlePrevDialogue}>
                  이전
                </button>
                <button className="dialogue_next_btn" onClick={handleNextDialogue}>
                  {getCurrentBtnText()}
                </button>
              </div>
            )}
          ...
          <div className="input_form_wrap">
            ...
            <div className="input_group">
              <div className="input_row">
                ...
                <div className="calendar_options">
                  <button
                    className={`calendar_btn ${calendar === "solar" ? "active" : ""}`}
                    onClick={() => setCalendar("solar")}
                  >
                    {calendar === "solar" && <span className="check_icon">✓</span>} 양력
                  </button>
                  <button
                    className={`calendar_btn ${calendar === "lunar" ? "active" : ""}`}
                    onClick={() => setCalendar("lunar")}
                  >
                    {calendar === "lunar" && <span className="check_icon">✓</span>} 음력
                  </button>
                </div>
              </div>
              <input
            ...
            <div className="input_group">
              <div className="input_row">
                ...
                <button
                  className={`time_unknown_btn ${birthTime === "unknown" ? "active" : ""}`}
                  onClick={() => setBirthTime(birthTime === "unknown" ? "" : "unknown")}
                >
                  {birthTime === "unknown" && <span className="check_icon">✓</span>} 시간 모름
                </button>
              </div>
              <select
                className="input_field"
            ...
            <div className="input_group">
              ...
              <div className="gender_options">
                <button
                  className={`gender_btn ${gender === "female" ? "active" : ""}`}
          ...
          <div className="input_form_wrap">
            ...
            <div className="input_group">
              ...
              <div className="status_options">
                <button
                  className={`status_btn ${status === "single" ? "active" : ""}`}
                ...
                <button
                  className={`status_btn ${status === "breakup" ? "active" : ""}`}
            ...
            <div className="input_group">
              ...
              <textarea
                ...
                placeholder={"현재 연애에 대한 고민이 있다면 적어주세요.\n더 정확한 분석을 해드릴게요."}
                rows={4}
                value={userConcern}
