                ...
                "contents": [
                    {"parts": [{"text": f"""
                        ...
                        - 다섯 항목을 다음 비율로 분배  
                            ...
                            |------|------------------|---------------|
                            | ① 부위별 관상 | **3,500자** | 오관·삼정·12궁 결과, 연계 해석, 천기누설 |
                            | ② 연애운 | **3,000자** | 인연 총량·타이밍·매력·상대 상성, 천기누설 |
                            | ③ 직업운 | **3,000자** | 재능·장단점·커리어 곡선·직장/창업 비교, 천기누설 |
                            | ④ 재물운 | **2,500자** | 평생 자산 시나리오·강약점·돈 붙는 환경, 천기누설 |
                            | ⑤ 건강운 | **2,500자** | 체질·약점·건강 곡선·위기 구간, 천기누설 |
                        ...
                        ** 반드시 글자 수를 지켜주세요. 총 15,000자 보고서를 발행해야합니다. 
                        ...
                        |------|-----------|--------------------|
                        | **① 부위별 관상** | 4~5문단 | • **오관**: 각 부위별 장·단점, 다섯 관리(官) 협업도<br>• **삼정**: 상·중·하정 길이·흉터·광택이 주는 초·중·말년 변곡점<br>• **12궁**: 12궁별 길흉 + 궁 간 상호작용 예시 1~2개<br>• **종합 진단**: 균형·불균형이 삶에 미칠 영향<br>• **천기누설**: 시술·이미지 개선 포인트 2~3가지 |
                        | **② 연애운** | 4문단 | • **연애 총량·주기**: 예상 횟수, 쉬는 주기 그래프 언급<br>• **타이밍**: 계절·장소·상황별 만남 확률과 이유<br>• **매력 포인트**: 도화살 위치, 19금 색기 지수, 활용 팁<br>• **이상적 상대**: 얼굴형·눈빛·성격 3가지 키워드<br>• **천기누설**: 인연이 살 지역·생활권 힌트 |
                        | **③ 직업운** | 4문단 | • **재능·장단점**: 상정·코·귀색과 일치하는 직능 분석<br>• **커리어 곡선**: 20‧30‧40‧50대별 성장/정체 구간<br>• **직장 vs 창업 비교**: 성공률·리스크·수익 구조 표<br>• **천기누설**: 최적 업종·부서, 연봉 피크 예측 연도 |
                        | **④ 재물운** | 4문단 | • **평생 자산 시나리오**: 보수·중립·공격형 3케이스<br>• **재물운 강‧약점**: 코·광대·팔자주름 분석, 지출 경계선<br>• **돈 붙는 환경**: 업·사람·공간·시간대별 금전 흐름<br>• **천기누설**: 재복을 키울 관상 관리·타이밍 |
                        | **⑤ 건강운** | 4문단 | • **타고난 체질**: 장부(臟腑) 강·약, 피부·귀색 징후<br>• **만성질환 소인**: 예방 우선순위 3가지<br>• **건강 곡선**: 20·40·60세 전후 위기 및 회복 지표<br>• **천기누설**: 필수 검진 월·전통 요법·생활 루틴 |

                        ────────────────────────────────────────
                        ## 정통 심층 관상 보고서

                        ### ① 부위별 관상 심층 풀이 
                        **①. 오관 분석** ― 눈·코·입·귀·눈썹을 통해 기질·재물·언변·수용력·인간관계를 종합해 성격 풀이  
                        **②. 삼정 분석** ― 이마·코·턱 세 구역으로 초년·중년·말년의 굴곡과 전환점 풀이  
                        **③. 12궁 분석** ― 얼굴 전체를 지도처럼 훑어 재물·관직·건강·인연까지 세부 운세 정밀 풀이  
                        ...
                        ### ② 연애운 심층 풀이 
                        **①. 타고난 인연** ― 총 연애 횟수와 연애 주기 예측, 첫사랑 시기와 영향력 분석  
                        **②. 만남 오픈 타이밍** ― 연애 기운이 가장 강한 계절·장소·상황 안내  
                        **③. 매력 풀이** ― 얼굴에서 드러나는 도화살, 매력 포인트, 19금 색기 지수 해석  
                        **④. 이상적 상대** ― 관상 상성(相性)으로 본 최적의 배우자 얼굴형·기질 묘사  
                        ++ **천기누설(天機漏洩)** ― 현재 인연이 머무는 가능성 높은 시·구 위치 예측  

                        ---

                        ### ③ 직업운 심층 풀이
                        **①. 적성과 장단점** ― 연봉 상한가를 찍을 직업군과 그대의 핵심 재능‧약점 분석  
                        **②. 직업 운 곡선** ― 커리어가 꽃피는 결정적 시기, 멈칫하는 구간, 재도약 전략  
                        **③. 직장 vs 창업** ― 성공 확률·적합도·스트레스 지수·수익 구조 상세 비교  
                        ++ **천기누설(天機漏洩)** ― 연봉 그래프 최고점을 찍을 구체적 업종·부서 예측  

                        ---

                        ### ④ 재물운 심층 풀이
                        **①. 타고난 부와 평생 모을 재산** ― 조상 덕, 본인 재물운, 최대 누적 자산 시나리오  
                        **②. 성향과 재물운의 강·약점** ― 돈과 만나는 장소·사람·습관, 지출 경계선  
                        **③. 돈이 붙는 적성과 환경** ― 부를 증식시키는 직업·투자·인맥·생활 패턴  
                        ++ **천기누설(天機漏洩)** ― 진짜 대박이 열릴 인생 시기 및 관상 개선 포인트  

                        ---

                        ### ⑤ 건강운 심층 풀이
                        **①. 타고난 체질 & 약점 탐색** ― 얼굴 빛·피부결·귀색·목선으로 보는 장부 강약과 만성질환 소인  
                        **②. 건강 곡선 & 위기 구간** ― 20·40·60세 전후 ‘주의 기점’, 회복 탄력성, 장수 가능성  
