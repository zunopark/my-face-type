...
async function requestPayment() {
  ...
  try {
    await paymentWidget.requestPayment({
      ...
      successUrl: `${window.location.origin}/jaeeunTest/analyze-success-payment/?id=${id}&type=${type}`,
      failUrl: `${window.location.origin}/jaeeunTest/fail.html?id=${id}&type=${type}`,
      customerName: "고객",
    });
  } catch (err) {
