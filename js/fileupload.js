...
const URL = "https://teachablemachine.withgoogle.com/models/GWEC9jHrV/";
...
async function predict() {
  ...
  let description = {
    ...
    // "재복과 인복이 좋은 관상": [
    //   "귀가 당나귀 귀라서 재복이 좋고 인복이 좋은 상입니다. 이마가 둥근형이라 결혼생활은 의문입니다. 처음에는 좋다가 나중에는 안좋을 수도 있습니다. 결혼을 최대한 늦게 하면 좋습니다. 두상이 작아서 판단력과 머리 회전이 빠르고 눈썹이 눈꼬리보다 길어서 재복이 아주 좋습니다. 이빨이 두상에 비해 큰 편이라서 성격 또한 시원시원 할 것입니다. ",
    //   "김태희",
    // ],

    // "남편을 잘만나야 현모양처인 관상": [
    //   "눈썹이 재복이 좋은 눈썹입니다. 눈이 내조를 잘하는 눈이면서 은근히 성욕을 밝히는 눈입니다. 입은 자기 속마음을 잘 말하지 않아 보이고 턱은 말년에 운이 좋아 연말에 행운을 기대해도 좋을 것 같습니다. 귀가 낭비벽이 심한 귀라 절제를 해야합니다. 하나 문제라면 이마때문에 남편이 사고칠 이마인데 정말 착한 남편을 만나면 괜찮은 관상입니다.",
    //   "문채원",
    // ],
