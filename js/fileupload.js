...
async function predict() {
  ...
  let description = {
    ...
    문채원: [
      "눈썹이 재복이 좋은 눈썹입니다. 눈은 내조를 잘하는 눈입니다. 입은 자기 속마음을 잘 말하지 않아 보이고 턱은 말년에 운이 좋아 연말에 행운을 기대해도 좋을 것 같습니다. 귀가 낭비벽이 심한 귀라 절제를 해야합니다. 하나 문제라면 이마때문에 남편이 사고칠 이마인데 정말 착한 남편을 만나면 괜찮은 관상입니다.",
      "남편을 잘만나야 현모양처인 관상",
      "chaewon",
    ],
    박보영: [
