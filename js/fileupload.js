...
async function predict() {
  ...
  let description = {
    ...
    "개방적인 성격의 관상":
      ["이마는 둥근형이라 집안일보다 바깥일을 좋아하고, 대인관계가 좋고 인복이 좋은 이마입니다. 눈썹은 재복이 좋고 미간이 넓어서 오픈마인드인 성격입니다. 눈은 고집과 자존심이 있는 눈이며 남자가 많이 따르는, 남자복이 많은 눈입니다. 턱은 재복이 좋지만 변덕이 심할 수 있고 연애운이 광하고 복스러우니 이성을 조심해야 합니다. 전체적으로 출세와 성공에 강합니다.", "강민경"],
    "결혼하면 잘살 관상":
