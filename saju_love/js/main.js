// API 엔드포인트
const SAJU_API_COMPUTE = "https://port-0-momzzi-fastapi-m7ynssht4601229b.sel4.cloudtype.app/saju/compute";
...
const additionalInputOverlay = document.getElementById('additionalInputOverlay');
...
function showButtons() {
  ...
  if (isInAdditionalDialogue) {
    dialogueNextBtn.textContent = additionalDialogues[currentAdditionalDialogue].nextBtnText;
  } else {
...
// 대화 박스 클릭해도 다음으로
dialogueWrap.querySelector('.dialogue_box').addEventListener('click', nextDialogue);
